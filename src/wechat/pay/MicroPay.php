...
use mark\wechat\pay\lib\WxPayApi;
use think\facade\Config;
use mark\wechat\pay\lib\WxPayReverse;
use mark\wechat\pay\lib\WxPayOrderQuery;
use mark\wechat\pay\lib\WxPayMicroPay;
use mark\wechat\pay\lib\WxPayException;
use Exception;
...
class MicroPay {
     ...
     */
    public function query(string $out_trade_no, &$succCode) {
     ...
     * @return bool
     */
    public function cancel(string $out_trade_no, $depth = 0) {
        try {
            if ($depth > 10) {
                return false;
            }
