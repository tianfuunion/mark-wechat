...
if (
    (isset($_REQUEST["transaction_id"]) && $_REQUEST["transaction_id"] != ""
...
<form action="#" method="post">
    ...
    <div align="center">
        <input type="submit" value="查询" style="width:210px; height:50px; border-radius: 15px;background-color:#FE6714; border:0 #FE6714 solid; cursor: pointer;  color:white;  font-size:16px;" type="button" onclick="callpay()"/>
    </div>
</form>
</body>
</html>
