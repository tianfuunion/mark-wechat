...
if (
    (isset($_REQUEST["bill_date"]) && !preg_match("/^[0-9-]{6,64}$/i", $_REQUEST["bill_date"], $matches))
...
<form action="#" method="post">
    ...
    <div align="center">
        <input type="submit" value="下载订单" style="width:210px; height:50px; border-radius: 15px;background-color:#FE6714; border:0 #FE6714 solid; cursor: pointer;  color:white;  font-size:16px;" type="button" onclick="callpay()"/>
    </div>
</form>
</body>
</html>
